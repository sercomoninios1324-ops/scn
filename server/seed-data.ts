export const INITIAL_DB = {
  ...
  products: [
    ...
    },
    {
      ...
      currency: 'ARS',
      includes: [
        'Smartphone SCN Nexus S24',
        'Funda de silicona transparente',
        'Cargador rápido de 45W',
        'Cable USB-C a USB-C',
    ...
    },
    {
      ...
      includes: [
        ...
        'Malla de silicona deportiva',
        'Base de carga magnética USB',
        'Manual de usuario',
      ],
      category_id: 'c1000000-0000-0000-0000-000000000003',
      is_featured: true,
    ...
    },
    {
      ...
      currency: 'ARS',
      includes: [
        'Auriculares SCN Buds Pro (L/R)',
        'Estuche de carga inalámbrica',
        '3 pares de almohadillas de silicona (S/M/L)',
        'Cable USB-C',
        'Manual',
      ],
      category_id: 'c1000000-0000-0000-0000-000000000002',
    ...
    },
    {
      ...
      currency: 'ARS',
      includes: [
        'Batería portátil SCN TurboCharge 20000mAh',
        'Cable USB-A a USB-C de carga rápida',
  ...
  product_images: [
    ...
    },
    {
      ...
      product_id: 'a1000000-0000-4000-8000-000000000003',
      storage_path:
    ...
    },
    {
      ...
      product_id: 'a1000000-0000-4000-8000-000000000004',
      storage_path:
    ...
    },
    {
      ...
      product_id: 'a1000000-0000-4000-8000-000000000005',
      storage_path:
    ...
    },
    {
      ...
      product_id: 'a1000000-0000-4000-8000-000000000006',
      storage_path:
    ...
    },
    {
      ...
      product_id: 'a1000000-0000-4000-8000-000000000007',
      storage_path:
        'https://images.unsplash.com/photo-1609592424085-f5b225577239?auto=format&fit=crop&w=800&q=80',
      position: 1,
      is_cover: true,
    },
    {
      id: 'b1000000-0000-4000-8000-000000000008',
      product_id: 'a1000000-0000-4000-8000-000000000008',
      storage_path:
  ...
  admins: [{ user_id: 'admin-user-id', name: 'Admin SCN' }],
  orders: [],
  order_items: [],
};

export type DbSchema = typeof INITIAL_DB;
