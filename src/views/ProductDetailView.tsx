...
export default function ProductDetailView({
  ...
  useEffect(() => {
    if (product) {
      const cover = product.images.find(img => img.is_cover)?.storage_path || product.images[0]?.storage_path || '';
    ...
    <div id="product-detail-view" className="page-enter mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-32 pt-6 space-y-12">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
        ...
        <div className="md:col-span-6 space-y-6">
          ...
          {/* What Includes List (¿Qué incluye?) */}
      ...
      {/* Floating purchase action on Mobile screens */}
