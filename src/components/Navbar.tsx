        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          {!isAdminLoggedIn ? (
            <button
              ...
              onClick={() => setCurrentPage('admin')}
              className="text-xs font-semibold text-scn-text-secondary hover:text-scn-primary transition-colors cursor-pointer"
            >
              Admin Acceso
            </button>
          ) : (
            ...
            <div className="border-t border-scn-border pt-4 pb-2">
              {isAdminLoggedIn ? (
                ...
                <button
                  ...
                  className="block w-full text-center px-4 py-2 rounded-lg border border-scn-border text-scn-text-normal text-sm font-semibold hover:bg-scn-bg-section transition-colors"
                >
